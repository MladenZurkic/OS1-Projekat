...
inline void Riscv::w_a1(uint64 writeValue) {
    __asm__ volatile ("mv a1, %0" : : "r"(writeValue));
}
...
inline void Riscv::w_a2(uint64 writeValue) {
    __asm__ volatile ("mv a2, %0" : : "r"(writeValue));
}
...
inline void Riscv::w_a3(uint64 writeValue) {
    __asm__ volatile ("mv a3, %0" : : "r"(writeValue));
}
...
inline void Riscv::w_a4(uint64 writeValue) {
    __asm__ volatile ("mv a4, %0" : : "r"(writeValue));
}
...
inline void Riscv::w_a5(uint64 writeValue) {
    __asm__ volatile ("mv a5, %0" : : "r"(writeValue));
}
...
inline void Riscv::w_a6(uint64 writeValue) {
    __asm__ volatile ("mv a6, %0" : : "r"(writeValue));
}
...
{
    uint64 volatile a7;
    __asm__ volatile ("mv %0, a3" : "=r"(a7));
    return a7;
}

inline void Riscv::w_a7(uint64 writeValue) {
    __asm__ volatile ("mv a7, %0" : : "r"(writeValue));
}
